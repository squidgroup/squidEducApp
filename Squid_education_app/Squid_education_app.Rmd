...
```{r mod1_step3, results="asis"}
  ...
  p(paste("$$Repeatability=\\frac{\\hat{V}_",NOT$devI,"}{\\hat{V}_",NOT$devI,"+\\hat{V}_",NOT$residualUpper,"}$$",sep=""))
...
```{r mod3_step1, results="asis"}
  cat(Mod3Step1_txt$goal)    # Text: goal
...
```{r mod3_step2, results="asis"}
  cat(Mod3Step2_txt$goal)    # Text: goal
...
```{r mod3_step3, results="asis"}
  cat(Mod3Step3_txt$goal)    # Text: goal
...
## Module 6: Random-slope regression
...
```{r mod6_step1_con, results="asis"}
    ...
    cat(Mod6Step1_txt$results)
    
    cat(Mod6Step1_txt$para4)
    
    cat(Mod6Step1_txt$point)
    
    cat(Mod6Step1_txt$point_eq1)
    cat(Mod6Step1_txt$point_eq2)
...
```{r mod6_step2, results="asis"}
    ...
    cat(Mod6Step2_txt$exercise_eq1)
    
    cat(Mod6Step2_txt$para4)
    
    cat(placeholder_image)
    
    cat(Mod6Step2_txt$results)
    
    cat(Mod6Step2_txt$para5)
    
    cat(Mod6Step2_txt$para6)
    cat(Mod6Step2_txt$point)
    
   cat(Mod6Step2_txt$point_eq1)
    p("where")
    cat(Mod6Step2_txt$point_eq2)
...
```{r mod6_step3, results="asis"}
    ...
    cat(Mod6Step3_txt$exercise_eq1)
...
## Module 7: MDPP and random regression

```{r mod7_step1_title, results="asis"}
cat("###",Mod7Step1_txt$title)
```
```{r mod7_step1, results="asis"}
  # Sub-goal
  cat(Mod7Step1_txt$goal)

  # Introduction
  cat(Mod7Step1_txt$intro)

  # Exercise
  cat(Mod7Step1_txt$exercise)

  # Equation
  cat(Mod7Step1_txt$exercise_eq1)
  
  cat(Mod7Step1_txt$para1)
  
  cat(Mod7Step1_txt$para2)
  
  cat(Mod7Step1_txt$para3)

  cat(Mod7Step1_txt$para4)
...
```{r mod7_step1_con, results="asis"}
  cat(Mod7Step1_txt$para5)
  cat(Mod7Step1_txt$para6)
    
  cat(Mod7Step1_txt$para7)

  cat(Mod7Step1_txt$para8)
  ...
  cat(Mod7Step1_txt$para9)
  
  cat(Mod7Step1_txt$para9_eq1)

  cat(Mod7Step1_txt$para10)
  
  cat(placeholder_image)
  
  cat(Mod7Step1_txt$para11)
...
```{r mod7_step1_con2, results="asis"}
  cat(Mod7Step1_txt$para12)
```
```{r mod7_step2_title, results="asis"}
cat("###",Mod7Step2_txt$title)
```
```{r mod7_step2, results="asis"}
  cat(Mod7Step2_txt$intro)


  cat(Mod7Step2_txt$para1)
  cat(Mod7Step2_txt$para1_eq1)
  
  cat(Mod7Step2_txt$para2)
  cat(Mod7Step2_txt$para2_eq1)
  
  cat(Mod7Step2_txt$para3)
  
  cat(Mod7Step2_txt$para4)
  cat(placeholder_image)

  cat(Mod7Step2_txt$para5)
  cat(Mod7Step2_txt$para5_eq1)
```

```{r mod7_step2_con, results="asis"}
  cat(Mod7Step2_txt$para6)
  cat(Mod7Step2_txt$para6_eq1)
...
#"Run this simulation several times with different values for the interaction term and the covariance terms. Where does the interaction term create the most phenotypic variance and how do covariances affect this?"
  ...
  cat(Mod7Step2_txt$para7)

  # Conclusion
  cat(Mod7Step2_txt$conclusion)
```
