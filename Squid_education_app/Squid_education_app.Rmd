...
```{r mod6_step1, results="asis"}
    ...
    displayRCode(Mod5Step1_txt$RCode1)
...
```{r mod6_step1_con, results="asis"}
    ...
    cat(Mod5Step1_txt$results)
    
    cat(Mod5Step1_txt$para4)
    
    cat(Mod5Step1_txt$point)
    
    cat(Mod5Step1_txt$point_eq1)
    cat(Mod5Step1_txt$point_eq2)
...
```{r mod6_step2, results="asis"}
    ...
    cat(Mod5Step2_txt$exercise_eq1)
    
    cat(Mod5Step2_txt$para4)
    
    cat(placeholder_image)
    
    cat(Mod5Step2_txt$results)
    
    cat(Mod5Step2_txt$para5)
    
    cat(Mod5Step2_txt$para6)
    cat(Mod5Step2_txt$point)
    
   cat(Mod5Step2_txt$point_eq1)
    p("where")
    cat(Mod5Step2_txt$point_eq2)
...
```{r mod6_step3_title, results="asis"}
    cat("###",Mod5Step3_txt$title)
```
```{r mod6_step3, results="asis"}
    cat(Mod5Step3_txt$goal)
    cat(Mod5Step3_txt$intro)
    cat(Mod5Step3_txt$exercise)
    
    cat(Mod5Step3_txt$exercise_eq1)
    
    cat(placeholder_image)
    
    cat(Mod5Step3_txt$para1)
    cat(Mod5Step3_txt$para2)
  
    cat(Mod5Step3_txt$para3)
    
    cat(placeholder_image)
           
    cat(Mod5Step3_txt$para4)
```
...
```{r mod4_step2, results="asis"}
  ...
  cat(Mod3Step2_txt$para5_eq1)
 
  cat(Mod3Step2_txt$para6)
  cat(Mod3Step2_txt$para6_eq1)
  ...
  cat(Mod3Step2_txt$para8)
  
  cat(Mod3Step2_txt$para8_eq1)
  
  cat(Mod3Step2_txt$para9)
...
```{r Mod3Step3, results="asis"}
 ...
 cat(Mod3Step3_txt$intro)
  ...
  cat(placeholder_image) # app 19
	...
	cat(Mod3Step3_txt$results)
	cat(Mod3Step3_txt$results_eq1)
	
	cat(Mod3Step3_txt$para1)
	cat(Mod3Step3_txt$para1_eq1)


	cat(Mod3Step3_txt$para2)
	
	cat(Mod3Step3_txt$para2_eq1)
	
	cat(Mod3Step3_txt$para3)
	
	cat(Mod3Step3_txt$para4)

	cat(Mod3Step3_txt$conclusion)
...
cat("###",Mod3Step4_txt$title)
```

```{r mod4_step4,results="asis"}
	# Sub-goal
	cat(Mod3Step4_txt$goal)
	
	
	cat(Mod3Step4_txt$intro)
	
	cat(Mod3Step4_txt$intro_eq1)
	
	cat(Mod3Step4_txt$para1)
	
	cat(Mod3Step4_txt$para1_eq1)
	
	cat(Mod3Step4_txt$para2)
	
	cat(Mod3Step4_txt$para2_eq1)
	
	cat(Mod3Step4_txt$para3)

	cat(Mod3Step4_txt$para3_eq1)
	
  cat(Mod3Step4_txt$para4)
	
	
	cat(Mod3Step4_txt$para4_eq1)
	
	cat(Mod3Step4_txt$para5)
	
	cat(Mod3Step4_txt$para5_eq1)
	
	cat(Mod3Step4_txt$para6)
	
	cat(Mod3Step4_txt$para6_eq1)
	
	cat(Mod3Step4_txt$para7)
	
	cat(Mod3Step4_txt$para7_eq1)
	
	cat(Mod3Step4_txt$para8)
	
	cat(Mod3Step4_txt$para8_eq1)
	
	cat(Mod3Step4_txt$conclusion)
```

```{r mod4_step5_title, results = "asis"}
	cat("###",Mod3Step5_txt$title)
```

```{r mod4_step5, results = "asis"}
	# Sub-goal
	cat(Mod3Step5_txt$goal)

	# Introduction
	cat(Mod3Step5_txt$intro)

	cat(Mod3Step5_txt$intro_eq1)
	
  cat(Mod3Step5_txt$para1)
	
	cat(Mod3Step5_txt$para1_eq1)

	cat(Mod3Step5_txt$para2)
	
	# Exercise
	cat(Mod3Step5_txt$exercise)
    
	cat(placeholder_image) # app 21
	
	cat(Mod3Step5_txt$para3)
	
	cat(Mod3Step5_txt$para3_eq1)
	
	cat(Mod3Step5_txt$para4)

	cat(Mod3Step5_txt$para4_eq1)
```
...
```{r mod4_step5_con,results="asis"}
	cat(Mod3Step5_txt$para5)
	
	cat(Mod3Step5_txt$para5_eq1)
```
...
```{r mod4_step5_con2, results="asis"}
	cat(Mod3Step5_txt$para6)
	
	cat(Mod3Step5_txt$conclusion)
```

## Module 5: Multi-dimensional Phenotypic Plasticity (MDPP)
...
## Module 6: MDPP and random regression

```{r mod7_step1_title, results="asis"}
cat("###",Mod6Step1_txt$title)
```
```{r mod7_step1, results="asis"}
  # Sub-goal
...
```{r mod7_step1_con, results="asis"}
  cat(Mod6Step1_txt$para5)
  cat(Mod6Step1_txt$para6)
    
  cat(Mod6Step1_txt$para7)

  cat(Mod6Step1_txt$para8)
  ...
  cat(Mod6Step1_txt$para9)
  
  cat(Mod6Step1_txt$para9_eq1)

  cat(Mod6Step1_txt$para10)
  
  cat(placeholder_image)
  
  cat(Mod6Step1_txt$para11)
...
```{r mod7_step1_con2, results="asis"}
  cat(Mod6Step1_txt$para12)
```
```{r mod7_step2_title, results="asis"}
cat("###",Mod6Step2_txt$title)
```
```{r mod7_step2, results="asis"}
...
```{r mod7_step2_con2, results="asis"}
##Q from text:
