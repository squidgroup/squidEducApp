#retrieved from https://github.com/mattblackwell/qsslearnr/blob/main/R/submission.R who got it from learnrhash
...
submission_ui <- shiny::div(
  "When you have completed this tutorial, follow these steps to print a progress report:",
  shiny::tags$br(),
  shiny::tags$ol(
    ...
    shiny::tags$li("Provide this report to your educator.")),
