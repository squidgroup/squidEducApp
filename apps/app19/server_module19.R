...
c(
  ...
  hide("show"),
    ...
    output$Mod4Step3_correlationplot <- renderPlot({
      ...
      if (!is.null(data)) {
        ...
        ggplot2::ggplot(dt, ggplot2::aes(x = Phenotype_1, Phenotype_2,  fill = as.factor(Individual), colour = as.factor(Individual))) +
          ...
          theme(legend.position="none") + ggtitle("Association of traits")
    ...
    output$Mod4Step3_Repeatability1 <- renderUI({
  ...
  output$Mod4Step3_Repeatability2 <- renderUI({
  ...
  # By default hide mathy bits
  hide("Mod4Step3_Among_Covariance_Matrix"),
  hide("Mod4Step3_Within_Covariance_Matrix"),
  hide("Mod4Step3_Phenotopic_correlation"),
  hide("Mod4Step3_Phenotopic_correlation2"),
  
    # Display hidden results
    observeEvent(input$show, {
      
      show("Mod4Step3_Among_Covariance_Matrix")
      show("Mod4Step3_Within_Covariance_Matrix")
      show("Mod4Step3_Phenotopic_correlation")
      show("Mod4Step3_Phenotopic_correlation2")
