    ...
    output$Mod8Step2_summary_table <- renderUI({ 
        ...
        myTable <- data.frame(
            ...
            "Estimated"      = c("Estimated",
                                 "(ommitting individual-specific interaction)",
                                 ...
                                 ifelse(!is.null(data), data$Vs2_1,"..."),
                                 "-",
                                 ifelse(!is.null(data), data$COVis1_1,"..."),
                                 ifelse(!is.null(data), data$COVis2_1,"..."),
                                 "-",
                                 ifelse(!is.null(data), data$COVs1s2_1,"..."),
                                 "-",
                                 "-",
            ...
            "Estimated_full" = c("Estimated",
                                 "(with individual-specific interaction)",
                                ...
                                ifelse(!is.null(data), data$Vi_2,"..."),
                                 ifelse(!is.null(data), data$Vs1_2,"..."),
                                 ifelse(!is.null(data), data$Vs2_2,"..."),
                                 ifelse(!is.null(data), data$Vs12_2,"..."),
                                 ifelse(!is.null(data), data$COVis1_2,"..."),
                                 ifelse(!is.null(data), data$COVis2_2,"..."),
                                 ifelse(!is.null(data), data$COVis12_2,"..."),
                                 ifelse(!is.null(data), data$COVs1s2_2,"..."),
                                 ifelse(!is.null(data), data$COVs1s12_2,"..."),
                                 ifelse(!is.null(data), data$COVs2s12_2,"..."),
